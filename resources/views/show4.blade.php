            ...
            <div class="song">
                ...
                <div class="video-grid">
                    <video class="video-js vjs-default-skin" width="707" height="407" controls data-setup='{}'>
                        <source src="video/BelajarBahasaInggris.mp4" type='video/mp4'>
                    </video>
                    <!-- <iframe src="https://www.youtube.com/embed/oYiT-vLjhC4" allowfullscreen></iframe> -->
                </div>
                <!-- title -->
                <div class="song-info">
                    <h3>Belajar Bahasa Inggris</h3>
                    <p class="author">Oleh <a href="#" class="author">Dini</a></p>
                    <p class="views"> 1 menyukai</p>
                    <div class="signin">
                ...
                <div class="media-body">
                    <ul id="video">
                        <li>
                            ...
                            <hr>
                            <div class="clearfix"> </div>
                            <p>bekajar nama buah dalam bahasa inggris</p>
                        </li>
                    </ul>
                </div>
            </div>
