  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <!-- logo -->  <a class="navbar-brand" href="{{ url('/test') }}"><h1><img src="images/pop.png" alt="" /></h1></a>
        </div>
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="shows.html" class="user-icon"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Favorite</a></li>
